...
`docs/doc_final.md` ya fue reescrito y su renderizado de verificación ocupa 3 páginas tamaño carta. Falta confirmar el formato de entrega, porque el enunciado dice "documentación técnica (máx. 5 páginas)" sin especificar si se entrega en PDF, documento de texto o Markdown.
